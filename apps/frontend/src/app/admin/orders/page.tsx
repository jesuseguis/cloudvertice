...
export default function AdminOrdersPage() {
  ...
  const { orders, total, isLoading } = useAdminOrders()
  ...
  return (
    <div className="min-h-screen bg-background-dark">
      <Header title="Órdenes" subtitle="Gestión de pedidos" />
          ...
          <Card>
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <h3 className="text-lg font-medium text-white mb-2">
                {statusFilter !== 'all' ? 'No hay órdenes con este estado' : 'No hay órdenes'}
              </h3>
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">Cliente #{order.userId.slice(0, 8)}</span>
                      </div>
                    </TableCell>
                    <TableCell>
